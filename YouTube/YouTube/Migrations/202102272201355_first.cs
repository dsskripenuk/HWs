namespace YouTube.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ChannelDescription = c.String(nullable: false),
        ...
        {
            DropForeignKey("dbo.tblVideos", "UserId", "dbo.tblUsers");
            DropForeignKey("dbo.tblUsers", "CategoryId", "dbo.tblCategories");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.tblVideos", new[] { "UserId" });
            DropIndex("dbo.tblUsers", new[] { "CategoryId" });
